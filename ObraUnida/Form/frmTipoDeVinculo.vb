...
Public Class frmTipoDeVinculo
    ...
    Private Sub TratarObjetos()
        ...
        If i > -1 And Not bIncluir Then
            ...
            cbNivOcp.Text = IIf(IsDBNull(dt.Rows(i).Item("UN022_NIVOCP")), "CNB", dt.Rows(i).Item("UN022_NIVOCP"))
            'chkAprAgr.Checked = IIf(IsDBNull(dt.Rows(i).Item("UN022_APRAGR")), False, dt.Rows(i).Item("UN022_APRAGR") = 1)
            If IsDBNull(dt.Rows(i).Item("UN022_APRAGR")) Then
                chkAprAgr.Checked = False
            Else
                chkAprAgr.Checked = dt.Rows(i).Item("UN022_APRAGR") = 1
            End If

            'chkAprIns.Checked = IIf(IsDBNull(dt.Rows(i).Item("UN022_APRINS")), False, dt.Rows(i).Item("UN022_APRINS") = 1)
            If IsDBNull(dt.Rows(i).Item("UN022_APRINS")) Then
                chkAprIns.Checked = False
            Else
                chkAprIns.Checked = dt.Rows(i).Item("UN022_APRINS") = 1
            End If
    ...
    Private Sub btnGravar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGravar.Click
        ...
        If ConectarBanco() Then
            ...
            If bIncluir Then
                cSql = "INSERT INTO EUN022(UN022_CODVIN, UN022_DESVIN, UN022_NIVOCP, UN022_APRAGR, UN022_APRINS)"
            ...
            ElseIf bAlterar Then
                cSql = "UPDATE EUN022 set UN022_DESVIN='" & txtDescricao.Text & "'" & _
                    ", UN022_NIVOCP='" & cbNivOcp.Text & "'" & _
                    ", UN022_APRAGR=" & IIf(chkAprAgr.Checked, 1, 0).ToString & _
                    ", UN022_APRINS=" & IIf(chkAprIns.Checked, 1, 0).ToString & _
