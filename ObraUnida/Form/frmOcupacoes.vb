...
Public Class frmOcupacoes
    ...
    Dim dt As DataTable = New DataTable("EUN020")
    ...
    Private Sub frmOcupacoes_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmOcupacoes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cQuery = "SELECT * FROM EUN020 where UN020_CODOCP = "
    ...
    Private Sub Excluir_Registro()
        ...
        If MsgBox("Deseja excluir este registro?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "cadastro de Usuarios") = MsgBoxResult.Yes Then
            ...
            cSql = "DELETE FROM EUN020 where UN020_CODOCP = " & Integer.Parse(txtCodigo.Text)
            cmd = New OleDbCommand(cSql, g_ConnectBanco)
